...
if(isset($_POST['submit'])){
  ...
  require 'class/class.phpmailer.php';
    ...
    $mail->AddAddress($_POST["email"], $_POST["sid"]); //Adds a "Cc" address
    $mail->WordWrap = 50;             //Sets word wrapping on the body of the message to a given number of characters
    $mail->IsHTML(true);              //Sets message type to HTML       
    $mail->Subject = 'Registration Successful';       //Sets the Subject of the message
    $mail->Body = "<div> <h3> We have received your Registration Successfully with Password : ".$_POST["pass1"]." provided after Registration . </h3> Please Remember Your Student ID is : " .$_POST["sid"]. "
    <h2>!! P.S : Kindly Change your Password for Security Reasons !!</h2>
     <pre> Adminstrator
...
$sql = mysqli_query($connect,"INSERT INTO `student` VALUES ('', '$cid', '$name', '$lname', '$dept', '$gender', '$dob', '$email',
 '$passwordmd5')");
...
<div class="row container">
  <div class="col-md-1" id="move">
   ...
   <form name="myform" class="myfrom container" method="POST" enctype="multipart/form-data">
    ...
    <input type="file" name="file" required="required">
      ...
      <input class="btn btn-primary-disabled" type="submit" name="submit_upload" value="Import"></p>
  </form>
 ...
 while ($row = mysqli_fetch_array($result)) {
  ...
  <div class="col-md-1">
    ...
    <form  name="form" class="action" action="std.php" method="POST" onsubmit="return validateForm();">
...
<input class="btn btn-default" type="submit" value="Search" name="button">
   ...
   if(isset($_GET['id']))
   {
        $result =mysqli_query($connect,"delete from student where id=".$_GET['id']);
