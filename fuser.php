...
<nav class="navbar navbar-default navbar-fixed-top"  role="navigation">
	<div class="container-fluid">
		<a class="navbar-brand" href="fuser.php">Exam Invgilation Allocation System</a>
	...
	<div class="navbar-header navbar-right">
		<ul class="nav navbar-nav">
			...
			<li><a href="fseat.php"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> View Allocated Hall</a></li>
			<li class="dropdown">
...
$query = mysqli_query($connect,"SELECT * FROM faculty WHERE tid = '".$_SESSION['name']."'");
  ...
  <p>$row[1]</p>
  <P>$row[4] </P>
  <p><a class='btn btn-primary ' href='feditprofile.php' role='button'>View Profile</a></p>";
  ?>
</div>
</div>
