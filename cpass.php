...
$query = mysqli_query($connect,"SELECT password FROM student WHERE sid = '".$_SESSION['name']."'");
...
?>
<form name="myform" class="myform" action="cpass.php" method="post" onsubmit="return validate();">
