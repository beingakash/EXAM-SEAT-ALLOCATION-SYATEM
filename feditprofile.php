...
$query = mysqli_query($connect,"SELECT * FROM faculty WHERE tid = '".$_SESSION['name']."'");
...
if( isset($_POST['submit']))
     {
              ...
              //$passwordmd5 = md5($_POST['pass']);
               $UpdateQuery = mysqli_query($connect,"UPDATE faculty SET tid ='$_POST[tid]', fname='$_POST[fname]', lname='$_POST[lname]', dob='$_POST[dob]', department='$_POST[dept]', email='$_POST[email]' WHERE ID='$id'");
...
<form class="myform" action="feditprofile.php" method="post">

   <br>

   <input type="hidden" name="tid" value="<?php echo $row[1];   ?>">
   <br>
   <br>
   <div class="form-group">
   <label for="exampleInputFname">First Name</label>
   <input type="text" name="fname" class="form-control" required="required" value="<?php echo $row[2];   ?>">
   </div>
   <div class="form-group">
   ...
   <input type="email" name="email" class="form-control" required="required" value="<?php echo $row[8];   ?>">
   </div>
