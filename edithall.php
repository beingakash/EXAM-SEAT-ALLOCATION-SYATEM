...
include_once("connect.php");
 ...
 if( isset($_GET['edit']))
     {
             $id = $_GET['edit'];
             $res = mysqli_query($connect,"SELECT * FROM hall WHERE ID='$id'");
     ...
     {
               $id = $_POST['id'];
               $UpdateQuery = mysqli_query($connect,"UPDATE hall SET hallId ='$_POST[hid]', name='$_POST[name]', capacity='$_POST[capacity]' WHERE ID='$id'");
...
<div class="row container">
  ...
  <div class="col-xs-6 space">
    <form class="myform" action="edithall.php" method="post">
      <div class="form-group">
      <label for="exampleInputDob">Hall ID</label>
      <input type="text" class="form-control" required="required" name="hid" value="<?php echo $row[1]; ?>">
      </div>
      <div class="form-group">
      ...
      <input type="text" class="form-control" name="capacity" required="required" value="<?php echo $row[3]; ?>">
      </div>
  <input type="hidden" name="id" value="<?php echo $row[0]; ?>">
  <input class="btn btn-primary" type="submit" value="Update" name="submit">
  <a class="btn btn-default" href="hall.php" role="button">Cancel</a>
</form>
  </div>
</div>
