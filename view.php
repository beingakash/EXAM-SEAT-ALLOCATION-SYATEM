...
<nav class="navbar navbar-default navbar-fixed-top"  role="navigation">
	...
	<div class="navbar-header navbar-right">
      ...
      <li class="active"><a href="view.php"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> View Course</a></li>
...
error_reporting(0);
 ...
 if(isset($_GET['id']))
{
  $result = mysqli_query($connect,"delete from subject where id=".$_GET['id']);
...
$query = mysqli_query($connect,"SELECT * FROM subject WHERE sid = '".$_SESSION['name']."'");
  while ($row = mysqli_fetch_array($query)) {
    echo "<tr>
          <td>".$row['cid']."</td>
          <td>".$row['name']."</td>
          <td><a href='view.php?id=".$row[0]."'><button type='button' class='btn btn-danger btn-sm'>Drop</button></a></td>
          </tr>";
  }
}
